...
StorageError = cast(type[Exception], import_module("eventradar.exceptions").StorageError)
...
RadarStorage = cast(_RadarStorageCtor, import_module("eventradar.storage").RadarStorage)
