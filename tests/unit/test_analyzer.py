...
Article = cast(_ArticleCtor, import_module("eventradar.models").Article)
EntityDefinition = cast(_EntityCtor, import_module("eventradar.models").EntityDefinition)
apply_entity_rules = cast(_ApplyEntityRules, import_module("eventradar.analyzer").apply_entity_rules)
